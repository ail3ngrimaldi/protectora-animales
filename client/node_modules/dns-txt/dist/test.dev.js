...
test('encode', function (t) {
  ...
  var expected = new Buffer('0a' + '537472696e67' + '3d' + '666f6f' + '09' + '6e756d626572' + '3d' + '3432' + '06' + '656d707479' + '3d' + '09' + '6e756c6c' + '3d' + '6e756c6c' + '04' + '626f6f6c' + '0a' + '627566666572' + '3d' + '626172', 'hex');
...
test('decode - exactly 256 bytes', function (t) {
  ...
  var result = txtStr.decode(encoded);
  t.deepEqual(result, expected);
  t.equal(txtStr.decode.bytes, encoded.length); // go beound the max:

...
exports.within = exports.getQueriesForElement = exports.bindElementToQueries = getQueriesForElement;
...
exports.screen = exports.queryHelpers = exports.queryByTitle = exports.queryByText = exports.queryByTestId = exports.queryByRole = exports.queryByPlaceholderText = exports.queryByLabelText = exports.queryByDisplayValue = exports.queryByAltText = exports.queryAllByTestId = exports.queryAllByPlaceholderText = exports.queries = exports.logRoles = exports.logDOM = exports.getByTitle = exports.getByText = exports.getByTestId = exports.getByRole = exports.getByPlaceholderText = exports.getByLabelText = exports.getByDisplayValue = exports.getByAltText = exports.getAllByTitle = exports.getAllByText = exports.getAllByTestId = exports.getAllByRole = exports.getAllByPlaceholderText = exports.getAllByDisplayValue = exports.getAllByAltText = exports.findByTitle = exports.findByText = exports.findByTestId = exports.findByRole = exports.findByPlaceholderText = exports.findByLabelText = exports.findByDisplayValue = exports.findByAltText = exports.findAllByTitle = exports.findAllByText = exports.findAllByTestId = exports.findAllByRole = exports.findAllByPlaceholderText = exports.findAllByLabelText = exports.findAllByDisplayValue = exports.findAllByAltText = exports.createEvent = void 0;
...
function newMutationObserver(onMutation) {
  var MutationObserverConstructor = typeof window !== 'undefined' && typeof window.MutationObserver !== 'undefined' ? window.MutationObserver : _mutationobserverShim["default"];
...
function prettyDOM(dom, maxLength, options) {
  ...
  var debugContent = (0, _prettyFormat["default"])(dom, (0, _extends4["default"])({
...
function queryAllByRole(container, role, _temp) {
  ...
  return Array.from(container.querySelectorAll('*')).filter(function (node) {
    ...
    return matches((0, _domAccessibilityApi.computeAccessibleName)(element), element, name, function (text) {
      return text;
    });
  });
}
...
Object.keys(eventMap).forEach(function (key) {
  ...
  createEvent[key] = function (node, init) {
    ...
    var value = _eventInit$target.value,
        ...
        targetProperties = (0, _objectWithoutPropertiesLoose2["default"])(_eventInit$target, ["value", "files"]);

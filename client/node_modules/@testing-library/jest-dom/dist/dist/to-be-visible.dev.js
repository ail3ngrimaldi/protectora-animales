...
function toBeVisible(element) {
  ...
  return {
    ...
    message: function message() {
      ...
      return [(0, _jestMatcherUtils.matcherHint)("".concat(_this.isNot ? '.not' : '', ".toBeVisible"), 'element', ''), '', "Received element ".concat(is, " visible:"), "  ".concat((0, _jestMatcherUtils.printReceived)(element.cloneNode(false)))].join('\n');
    }
  };
}
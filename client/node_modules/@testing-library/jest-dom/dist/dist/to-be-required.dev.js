...
function toBeRequired(element) {
  ...
  return {
    ...
    message: function message() {
      ...
      return [(0, _jestMatcherUtils.matcherHint)("".concat(_this.isNot ? '.not' : '', ".toBeRequired"), 'element', ''), '', "Received element ".concat(is, " required:"), "  ".concat((0, _jestMatcherUtils.printReceived)(element.cloneNode(false)))].join('\n');
    }
  };
}
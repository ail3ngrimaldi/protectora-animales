...
function toBeDisabled(element) {
  ...
  return {
    ...
    message: function message() {
      ...
      return [(0, _jestMatcherUtils.matcherHint)("".concat(_this.isNot ? '.not' : '', ".toBeDisabled"), 'element', ''), '', "Received element ".concat(is, " disabled:"), "  ".concat((0, _jestMatcherUtils.printReceived)(element.cloneNode(false)))].join('\n');
    }
  };
}
...
function toBeEnabled(element) {
  ...
  return {
    ...
    message: function message() {
      ...
      return [(0, _jestMatcherUtils.matcherHint)("".concat(_this2.isNot ? '.not' : '', ".toBeEnabled"), 'element', ''), '', "Received element ".concat(is, " enabled:"), "  ".concat((0, _jestMatcherUtils.printReceived)(element.cloneNode(false)))].join('\n');
    }
  };
}
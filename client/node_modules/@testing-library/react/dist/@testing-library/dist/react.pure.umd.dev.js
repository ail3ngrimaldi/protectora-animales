...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-dom'), require('react-dom/test-utils')) : typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-dom', 'react-dom/test-utils'], factory) : (global = global || self, factory(global.TestingLibraryReact = {}, global.React, global.ReactDom, global.testUtils));
})(void 0, function (exports, React, ReactDOM, testUtils) {
  'use strict';
  ...
  */
  ...
  var ReactTestComponent = createCommonjsModule(function (module, exports) {
    ...
    var testSymbol = typeof _Symbol2 === 'function' && _Symbol2["for"] ? _Symbol2["for"]('react.test.json') : 0xea71357;
  ...
  */
  ...
  var defineIterator = function defineIterator(Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
    ...
    if (DEFAULT == VALUES && nativeIterator && nativeIterator.name !== VALUES) {
      ...
      defaultIterator = function defaultIterator() {
  ...
  unwrapExports(rolesMap_1); // `Set` constructor
  ...
  var set$1 = path.Set;
  var set$2 = set$1;
  var set$3 = set$2; // https://tc39.github.io/ecma262/#sec-array.isarray
  ...
  var arrayWithoutHoles = _arrayWithoutHoles; // `Array.from` method implementation

...
(0, _dom.configure)({
  asyncWrapper: function () {
    var _asyncWrapper = (0, _asyncToGenerator2["default"])(
    /*#__PURE__*/
...
function fireEvent() {
  ...
  var returnValue;
  act(function () {
    returnValue = _dom.fireEvent.apply(void 0, args);
  });
  return returnValue;
}
...
Object.keys(_dom.fireEvent).forEach(function (key) {
  fireEvent[key] = function () {
    ...
    var returnValue;
    act(function () {
      returnValue = _dom.fireEvent[key].apply(_dom.fireEvent, args);
    });
    return returnValue;
  };

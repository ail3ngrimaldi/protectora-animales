...
function tryParseSelector(rawSelector) {
  try {
    ...
    if (typeof err.offset === "number") {
      throw new SyntaxError("Syntax error in selector \"".concat(rawSelector, "\" at position ").concat(err.offset, ": ").concat(err.message));
    }
...
function () {
  ...
  function NodeEventGenerator(emitter) {
    ...
    emitter.eventNames().forEach(function (rawSelector) {
      ...
      var selectors = selector.isExit ? _this.anyTypeExitSelectors : _this.anyTypeEnterSelectors;

...
function () {
  ...
  function CodePathState(idGenerator, onLooped) {
    ...
    var _final = this.finalSegments = [];

    var returned = this.returnedForkContext = [];
    var thrown = this.thrownForkContext = [];
    returned.add = addToReturnedOrThrown.bind(null, returned, thrown, _final);
    thrown.add = addToReturnedOrThrown.bind(null, thrown, returned, _final);
  }
  /**
   * The head segments.
  ...
  _createClass(CodePathState, [{
    ...
    value: function popTryContext() {
      ...
      var leavingSegments = headSegments.slice(headSegments.length / 2 | 0); // Forwards the leaving path to upper contexts.
    ...
    value: function makeCatchBlock() {
      var context = this.tryContext;
      var forkContext = this.forkContext;
      var thrown = context.thrownForkContext; // Update state.
      ...
      var thrownSegments = thrown.makeNext(0, -1); // Fork to a bypass and the merged thrown path.
    ...
    value: function makeFinallyBlock() {
      ...
      var returned = context.returnedForkContext;
      var thrown = context.thrownForkContext;
      var headOfLeavingSegments = forkContext.head; // Update state.
    ...
    value: function popLoopContext() {
      ...
      var forkContext = this.forkContext;
      var brokenForkContext = this.popBreakContext().brokenForkContext; // Creates a looped path.
    ...
    value: function makeWhileTest(test) {
      var context = this.loopContext;
      var forkContext = this.forkContext;
      var testSegments = forkContext.makeNext(0, -1); // Update state.
    ...
    value: function makeDoWhileBody() {
      var context = this.loopContext;
      var forkContext = this.forkContext;
      var bodySegments = forkContext.makeNext(-1, -1); // Update state.
    ...
    value: function makeForTest(test) {
      ...
      var testSegments = forkContext.makeNext(-1, -1); // Update state.
    ...
    value: function makeForUpdate() {
      var context = this.loopContext;
      var choiceContext = this.choiceContext;
      var forkContext = this.forkContext; // Make the next paths of the test.
    ...
    value: function makeForBody() {
      var context = this.loopContext;
      var choiceContext = this.choiceContext;
      var forkContext = this.forkContext; // Update state.
    ...
    value: function makeForInOfLeft() {
      var context = this.loopContext;
      var forkContext = this.forkContext;
      var leftSegments = forkContext.makeDisconnected(-1, -1); // Update state.
    ...
    value: function makeForInOfRight() {
      ...
      var rightSegments = temp.makeNext(-1, -1); // Update state.
    ...
    value: function makeForInOfBody() {
      ...
      var bodySegments = temp.makeNext(-1, -1); // Make a path: `right` -> `left`.

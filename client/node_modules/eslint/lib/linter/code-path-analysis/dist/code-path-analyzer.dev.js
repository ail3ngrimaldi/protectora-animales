...
var assert = require("assert"),
    _require = require("../../shared/ast-utils"),
    breakableTypePattern = _require.breakableTypePattern,
...
function forwardCurrentToHead(analyzer, node) {
  ...
  var i, currentSegment, headSegment; // Fires leaving events.
...
function postprocess(analyzer, node) {
  switch (node.type) {
    ...
    case "ArrowFunctionExpression":
      {
        var codePath = analyzer.codePath; // Mark the current path as the final node.

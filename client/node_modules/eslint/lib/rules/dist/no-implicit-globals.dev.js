...
module.exports = {
  ...
  create: function create(context) {
    var checkLexicalBindings = context.options[0] && context.options[0].lexicalBindings === true;
    /**
     * Reports the node.
    ...
    return {
      Program: function Program() {
        ...
        scope.variables.forEach(function (variable) {
          ...
          var isReadonlyEslintGlobalVariable = variable.writeable === false;
          var isWritableEslintGlobalVariable = variable.writeable === true;

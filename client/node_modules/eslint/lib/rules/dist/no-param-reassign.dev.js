...
module.exports = {
  ...
  create: function create(context) {
    var props = context.options[0] && context.options[0].props;
    var ignoredPropertyAssignmentsFor = context.options[0] && context.options[0].ignorePropertyModificationsFor || [];
    var ignoredPropertyAssignmentsForRegex = context.options[0] && context.options[0].ignorePropertyModificationsForRegex || [];
    /**
    ...
    function isIgnoredPropertyAssignment(identifierName) {
      return ignoredPropertyAssignmentsFor.includes(identifierName) || ignoredPropertyAssignmentsForRegex.some(function (ignored) {
        return new RegExp(ignored, "u").test(identifierName);
      });
    }
    /**

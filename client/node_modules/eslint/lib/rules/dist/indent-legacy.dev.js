  ...
  create: function create(context) {
    ...
    if (context.options.length) {
      ...
      if (context.options[1]) {
        ...
        } else if (_typeof(variableDeclaratorRules) === "object") {
    ...
    function getNodeIndent(node, byLastLine) {
      ...
      var indentChars = srcCharsBeforeNode.slice(0, srcCharsBeforeNode.findIndex(function (_char) {
        return _char !== " " && _char !== "\t";
      }));
      var spaces = indentChars.filter(function (_char2) {
        return _char2 === " ";
      }).length;
      var tabs = indentChars.filter(function (_char3) {
        return _char3 === "\t";
      }).length;
      return {
        space: spaces,
    ...
    function getParentNodeByType(node, type, stopAtList) {
      ...
      var stopAtSet = new Set(stopAtList || ["Program"]);
    ...
    function checkIndentInArrayOrObjectBlock(node) {
      ...
      var elements = node.type === "ArrayExpression" ? node.elements : node.properties; // filter out empty elements example would be [ , 2] so remove first element as espree considers it as null
      ...
      var nodeIndent;
      var elementsIndent;
      var parentVarNode = getVariableDeclaratorNode(node); // TODO - come up with a better strategy in future
    ...
    function expectedCaseIndent(node, providedSwitchIndent) {
      ...
      var switchIndent = typeof providedSwitchIndent === "undefined" ? getNodeIndent(switchNode).goodChar : providedSwitchIndent;
      var caseIndent;
    ...
    return {
      ...
      ReturnStatement: function ReturnStatement(node) {
        ...
        var firstLineIndent = getNodeIndent(node).goodChar; // in case if return statement is wrapped in parenthesis

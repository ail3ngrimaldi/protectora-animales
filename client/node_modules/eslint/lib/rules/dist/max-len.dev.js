...
module.exports = {
  ...
  create: function create(context) {
    ...
    var options = Object.assign({}, context.options[context.options.length - 1]); // …but max code length…
    ...
    var maxLength = typeof options.code === "number" ? options.code : 80,
    ...
    function stripTrailingComment(line, comment) {
      ...
      return line.slice(0, comment.loc.start.column).replace(/[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]+$/, "");
    }
    /**
    ...
    function getAllStrings() {
      return sourceCode.ast.tokens.filter(function (token) {
        return token.type === "String" || token.type === "JSXText" && sourceCode.getNodeByRangeIndex(token.range[0] - 1).type === "JSXAttribute";
      });
    }
    /**
    ...
    function checkProgramForMaxLength(node) {
      ...
      lines.forEach(function (line, i) {
        ...
        if (commentsIndex < comments.length) {
          var comment = null; // iterate over comments until we find one past the current line
        ...
        var lineLength = computeLineLength(textToMeasure, tabWidth);

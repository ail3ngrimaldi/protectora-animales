    ...
    function reportError(node, initial, result, type) {
      ...
      return context.report({
        ...
        fix: function fix(fixer) {
          ...
          var replacementText = result.type === "AssignmentPattern" ? sourceCode.getText(result) : name;
    ...
    function checkDestructured(node) {
      ...
      try {
        for (var _iterator = node.properties[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          var key = property.key.type === "Identifier" && property.key.name || property.key.type === "Literal" && property.key.value;
          var renamedKey = property.value.type === "AssignmentPattern" ? property.value.left.name : property.value.name;

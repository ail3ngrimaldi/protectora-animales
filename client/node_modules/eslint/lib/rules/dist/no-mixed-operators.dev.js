...
var ALL_OPERATORS = [].concat(ARITHMETIC_OPERATORS, BITWISE_OPERATORS, COMPARISON_OPERATORS, LOGICAL_OPERATORS, RELATIONAL_OPERATORS, TERNARY_OPERATOR);
var DEFAULT_GROUPS = [ARITHMETIC_OPERATORS, BITWISE_OPERATORS, COMPARISON_OPERATORS, LOGICAL_OPERATORS, RELATIONAL_OPERATORS];
var TARGET_NODE_TYPE = /^(?:Binary|Logical|Conditional)Expression$/;
/**
 * Normalizes options.
...
function normalizeOptions() {
  ...
  var hasGroups = options.groups && options.groups.length > 0;
  var groups = hasGroups ? options.groups : DEFAULT_GROUPS;
  var allowSamePrecedence = options.allowSamePrecedence !== false;
  return {
    groups: groups,
...
module.exports = {
  ...
  create: function create(context) {
    ...
    function reportBothOperators(node) {
      ...
      var left = getChildNode(parent) === node ? node : parent;
      var right = getChildNode(parent) !== node ? node : parent;

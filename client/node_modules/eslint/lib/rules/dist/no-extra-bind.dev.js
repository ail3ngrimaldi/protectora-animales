    ...
    function report(node) {
      context.report({
        ...
        fix: function fix(fixer) {
          ...
          var firstTokenToRemove = sourceCode.getFirstTokenBetween(node.parent.object, node.parent.property, astUtils.isNotClosingParenToken);
          var lastTokenToRemove = sourceCode.getLastToken(node.parent.parent);

...
function parseRegExp(regExpText) {
  var charList = [];
  regExpText.split("").reduce(function (state, _char, index) {
...
module.exports = {
  ...
  create: function create(context) {
    ...
    function report(node, startOffset, character) {
      var start = sourceCode.getLocFromIndex(sourceCode.getIndexFromLoc(node.loc.start) + startOffset);
      var rangeStart = sourceCode.getIndexFromLoc(node.loc.start) + startOffset;
      var range = [rangeStart, rangeStart + 1];
      context.report({
        node: node,
        loc: {
          start: start,

  ...
  create: function create(context) {
    ...
    function getCommentLineNumbers(comments) {
      ...
      comments.forEach(function (comment) {
        var endLine = comment.type === "Block" ? comment.loc.end.line - 1 : comment.loc.end.line;

        for (var i = comment.loc.start.line; i <= endLine; i++) {
          lines.add(i);
        }
      });
      return lines;
      ...
      Program: function checkTrailingSpaces(node) {
        ...
        for (var i = 0, ii = lines.length; i < ii; i++) {
          ...
          if (matches) {
            ...
            var rangeStart = totalLength + location.start.column;
            var rangeEnd = totalLength + location.end.column;

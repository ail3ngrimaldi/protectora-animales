...
var LT = "[".concat(Array.from(astUtils.LINEBREAKS).join(""), "]");
var PADDING_LINE_SEQUENCE = new RegExp(String.raw(_templateObject(), LT, LT), "u");
var CJS_EXPORT = /^(?:module[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*\.[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*)?exports(?:[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*\.|[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*\[|$)/;
  ...
  create: function create(context) {
    ...
    function getPaddingLineSequences(prevNode, nextNode) {
      ...
      if (nextNode.loc.start.line - prevToken.loc.end.line >= 2) {
        do {
          var token = sourceCode.getTokenAfter(prevToken, {
            includeComments: true
          });
    ...
    function verify(node) {
      ...
      var prevNode = scopeInfo.prevNode; // Verify.

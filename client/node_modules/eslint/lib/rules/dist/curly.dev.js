  ...
  create: function create(context) {
    ...
    function requiresBraceOfConsequent(node) {
      if (node.alternate && node.consequent.type === "BlockStatement") {
        ...
        for (var currentNode = node.consequent.body[0]; currentNode; currentNode = astUtils.getTrailingStatement(currentNode)) {
    ...
    function prepareCheck(node, body, name, opts) {
      ...
      if (node.type === "IfStatement" && node.consequent === body && requiresBraceOfConsequent(node)) {
        ...
        if (hasBlock && body.body.length === 1 && isOneLiner(body.body[0])) {
          ...
          var isLexDef = isLexicalDeclaration(body.body[0]);
            ...
            if (this.expected) {
              context.report({
                ...
                fix: function fix(fixer) {
                  return fixer.replaceText(body, "{".concat(sourceCode.getText(body), "}"));
                }
              });
            } else {
              context.report({
                ...
                fix: function fix(fixer) {
                   ...
                   */
                  var needsPrecedingSpace = node.type === "DoWhileStatement" && sourceCode.getTokenBefore(body).range[1] === body.range[0] && !astUtils.canTokensBeAdjacent("do", sourceCode.getFirstToken(body, {
                    skip: 1
                  }));
    ...
    function prepareIfChecks(node) {
      ...
      for (var currentNode = node; currentNode; currentNode = currentNode.alternate) {

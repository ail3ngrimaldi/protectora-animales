...
function getContainingLoopNode(node) {
  for (var currentNode = node; currentNode.parent; currentNode = currentNode.parent) {
...
function isSafe(loopNode, reference) {
  ...
  var kind = declaration && declaration.type === "VariableDeclaration" ? declaration.kind : ""; // Variables which are declared by `const` is safe.
...
module.exports = {
  ...
  create: function create(context) {
    ...
    function checkForLoops(node) {
      ...
      var unsafeRefs = references.filter(function (r) {
        return !isSafe(loopNode, r);
      }).map(function (r) {

...
module.exports = {
  ...
  create: function create(context) {
    ...
    var sourceCode = context.getSourceCode(); // Swallow the final newline, as some editors add it automatically and we don't want it to cause an issue
          ...
          if (lineNumber - lastLineNumber - 1 > maxAllowed) {
            context.report({
              ...
              fix: function fix(fixer) {
                var rangeStart = sourceCode.getIndexFromLoc({
                ...
                var rangeEnd = lineNumberAfterRemovedLines <= allLines.length ? sourceCode.getIndexFromLoc({

...
module.exports = {
  ...
  create: function create(context) {
    ...
    function findLastConsecutiveTokenAfter(prevLastToken, nextFirstToken, maxLine) {
      var after = sourceCode.getTokenAfter(prevLastToken, {
    ...
    function findFirstConsecutiveTokenBefore(nextFirstToken, prevLastToken, maxLine) {
      var before = sourceCode.getTokenBefore(nextFirstToken, {
        includeComments: true
      });
    ...
    return {
      ClassBody: function ClassBody(node) {
        ...
        var _loop = function _loop(i) {
          ...
          var beforePadding = findLastConsecutiveTokenAfter(curLast, nextFirst, 1);
          var afterPadding = findFirstConsecutiveTokenBefore(nextFirst, curLast, 1);
          var isPadded = afterPadding.loc.start.line - beforePadding.loc.end.line > 1;
          var hasTokenInPadding = hasTokenOrCommentBetween(beforePadding, afterPadding);
          var curLineLastToken = findLastConsecutiveTokenAfter(curLast, nextFirst, 0);

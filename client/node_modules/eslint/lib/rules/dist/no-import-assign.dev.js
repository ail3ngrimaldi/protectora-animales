...
function isArgumentOfWellKnownMutationFunction(node, scope) {
  ...
  if (parent.type === "CallExpression" && parent.arguments[0] === node && parent.callee.type === "MemberExpression" && parent.callee.object.type === "Identifier") {
    ...
    if (Object.keys(MutationMethods).includes(object.name)) {
      var variable = findVariable(scope, object);
      ...
      ImportDeclaration: function ImportDeclaration(node) {
        ...
        try {
          for (var _iterator = context.getDeclaredVariables(node)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            var shouldCheckMembers = variable.defs.some(function (d) {
              return d.node.type === "ImportNamespaceSpecifier";
            });
            var prevIdNode = null;
            ...
            try {
              for (var _iterator2 = variable.references[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                var reference = _step2.value;
                var idNode = reference.identifier;
                /*

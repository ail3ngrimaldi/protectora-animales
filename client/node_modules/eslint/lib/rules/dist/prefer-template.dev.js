...
function isOctalEscapeSequence(node) {
  ...
  var isStringLiteral = node.type === "Literal" && typeof node.value === "string";
  ...
  create: function create(context) {
    ...
    function getTemplateLiteral(currentNode, textBeforeNode, textAfterNode) {
      if (currentNode.type === "Literal" && typeof currentNode.value === "string") {
         ...
         */
        return "`".concat(currentNode.raw.slice(1, -1).replace(/\\*(\$\{|`)/g, function (matched) {
    ...
    function checkForStringConcat(node) {
      ...
      var topBinaryExpr = getTopConcatBinaryExpression(node.parent); // Checks whether or not this node had been checked already.

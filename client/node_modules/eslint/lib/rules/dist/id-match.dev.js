...
module.exports = {
  ...
  create: function create(context) {
    ...
    var reported = new Map();
    var ALLOWED_PARENT_TYPES = new Set(["CallExpression", "NewExpression"]);
    var DECLARATION_TYPES = new Set(["FunctionDeclaration", "VariableDeclarator"]);
    var IMPORT_TYPES = new Set(["ImportSpecifier", "ImportNamespaceSpecifier", "ImportDefaultSpecifier"]);
    /**
      ...
      Identifier: function Identifier(node) {
        ...
        if (parent.type === "MemberExpression") {
          ...
          if (parent.parent && parent.parent.type === "ObjectPattern") {
            ...
            var assignmentKeyEqualsValue = parent.key.name === parent.value.name; // prevent checking righthand side of destructured object

            if (!assignmentKeyEqualsValue && parent.key === node) {
              return;
            }

            var valueIsInvalid = parent.value.name && isInvalid(name); // ignore destructuring if the option is set, unless a new identifier is created

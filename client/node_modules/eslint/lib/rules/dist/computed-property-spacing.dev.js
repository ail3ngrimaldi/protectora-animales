...
module.exports = {
  ...
  create: function create(context) {
    ...
    var enforceForClassMembers = context.options[1] && context.options[1].enforceForClassMembers; //--------------------------------------------------------------------------
    // Helpers
    //--------------------------------------------------------------------------
    ...
    function checkSpacing(propertyName) {
      return function (node) {
        ...
        var before = sourceCode.getTokenBefore(property, astUtils.isOpeningBracketToken),

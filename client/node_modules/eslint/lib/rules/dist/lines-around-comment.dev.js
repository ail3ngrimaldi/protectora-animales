...
module.exports = {
  ...
  create: function create(context) {
    var options = Object.assign({}, context.options[0]);
    ...
    function checkForEmptyLine(token, opts) {
      ...
      var exceptionEndAllowed = blockEndAllowed || classEndAllowed || objectEndAllowed || arrayEndAllowed; // ignore top of the file and bottom of the file
      ...
      var previousTokenOrComment = sourceCode.getTokenBefore(token, {
        includeComments: true
      });
      var nextTokenOrComment = sourceCode.getTokenAfter(token, {
        includeComments: true

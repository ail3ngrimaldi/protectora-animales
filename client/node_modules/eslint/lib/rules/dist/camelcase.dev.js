...
module.exports = {
  ...
  create: function create(context) {
    ...
    var ignoreDestructuring = options.ignoreDestructuring;
    var ignoreImports = options.ignoreImports;
    ...
    function isAllowed(name) {
      return allow.some(function (entry) {
        return name === entry || name.match(new RegExp(entry, "u"));
      });
    }
    /**
      ...
      Identifier: function Identifier(node) {
        ...
        if (node.parent.type === "MemberExpression") {
          ...
          if (node.parent.parent && node.parent.parent.type === "ObjectPattern") {
            ...
            var valueIsUnderscored = node.parent.value.name && nameIsUnderscored; // ignore destructuring if the option is set, unless a new identifier is created

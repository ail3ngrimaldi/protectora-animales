...
function () {
  ...
  function RuleConfigSet(configs) {
    _classCallCheck(this, RuleConfigSet);
  ...
  _createClass(RuleConfigSet, [{
    key: "addErrorSeverity",
    value: function addErrorSeverity() {
      var severity = 2;
...
function createCoreRuleConfigs() {
  var noDeprecated = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
  return Array.from(builtInRules).reduce(function (accumulator, _ref) {
    var _ref2 = _slicedToArray(_ref, 2),
        id = _ref2[0],
        rule = _ref2[1];

    var schema = typeof rule === "function" ? rule.schema : rule.meta.schema;
    var isDeprecated = typeof rule === "function" ? rule.deprecated : rule.meta.deprecated;

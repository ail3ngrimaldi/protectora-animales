...
function () {
  ...
  _createClass(Registry, [{
    key: "populateFromCoreRules",
    value: function populateFromCoreRules() {
    ...
    key: "stripFailingConfigs",
    value: function stripFailingConfigs() {
      var ruleIds = Object.keys(this.rules),
    ...
    key: "stripExtraConfigs",
    value: function stripExtraConfigs() {
      var ruleIds = Object.keys(this.rules),
          newRegistry = new Registry();
      newRegistry.rules = Object.assign({}, this.rules);
      ruleIds.forEach(function (ruleId) {
    ...
    key: "getFailingRulesRegistry",
    value: function getFailingRulesRegistry() {
      var _this = this;

      var ruleIds = Object.keys(this.rules),
          failingRegistry = new Registry();
      ruleIds.forEach(function (ruleId) {
        var failingConfigs = _this.rules[ruleId].filter(function (registryItem) {
          return registryItem.errorCount > 0;
        });

        if (failingConfigs && failingConfigs.length === _this.rules[ruleId].length) {
    ...
    value: function createConfig() {
      ...
      ruleIds.forEach(function (ruleId) {
        if (_this2.rules[ruleId].length === 1) {
          config.rules[ruleId] = _this2.rules[ruleId][0].config;
        }
      });
      return config;
    }
    ...
    key: "filterBySpecificity",
    value: function filterBySpecificity(specificity) {
      var _this3 = this;
      ...
      newRegistry.rules = Object.assign({}, this.rules);
      ruleIds.forEach(function (ruleId) {
        newRegistry.rules[ruleId] = _this3.rules[ruleId].filter(function (registryItem) {
    ...
    key: "lintSourceCode",
    value: function lintSourceCode(sourceCodes, config, cb) {
      var lintedRegistry = new Registry();
      ...
      filenames.forEach(function (filename) {
        debug("Linting file: ".concat(filename));
        var ruleSetIdx = 0;
        ruleSets.forEach(function (ruleSet) {
          var lintConfig = Object.assign({}, config, {
            rules: ruleSet
          });
          var lintResults = linter.verify(sourceCodes[filename], lintConfig);

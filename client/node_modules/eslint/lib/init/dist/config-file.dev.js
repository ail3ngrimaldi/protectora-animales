...
function writeJSONConfigFile(config, filePath) {
  debug("Writing JSON config file: ".concat(filePath));
...
function writeYAMLConfigFile(config, filePath) {
  debug("Writing YAML config file: ".concat(filePath)); // lazy load YAML to improve performance when not used
...
function writeJSConfigFile(config, filePath) {
  debug("Writing JS config file: ".concat(filePath));
  var contentToWrite;
  var stringifiedContent = "module.exports = ".concat(stringify(config, {
    cmp: sortByKey,
    space: 4
  }), ";");
  ...
  try {
    ...
    var report = linter.executeOnText(stringifiedContent);

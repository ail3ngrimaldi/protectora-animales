...
var floatFallback = _float({});

global.Float32Array = F32;
global.Float64Array = F64;
var buf = new Buffer(8);
newSuite("writeFloat").add("float", function () {
  _float.writeFloatLE(0.1, buf, 0);
...
newSuite("readFloat").add("float", function () {
  _float.readFloatLE(buf, 0);
}).add("float (fallback)", function () {
...
newSuite("writeDouble").add("float", function () {
  _float.writeDoubleLE(0.1, buf, 0);
}).add("float (fallback)", function () {
...
newSuite("readDouble").add("float", function () {
  _float.readDoubleLE(buf, 0);
}).add("float (fallback)", function () {

  ...
  return function o(i, n, l) {
    ...
    5: [function (e, r, t) {
      ...
      function C(e, c, u, r) {
        ...
        function x(e, r, t, a) {
          ...
          if (l) n = l.call(d, r, t, a);else if (u) n = u.call(d, r, t, a), !1 !== p.validateSchema && d.validateSchema(n, !0);else if (c) n = c.call(d, a, e.keyword, r, t);else if (!(n = e.definition.validate)) return;
      ...
      r.exports = function () {
        ...
        return a.all = i(s), a.types = i(["number", "integer", "string", "array", "object", "boolean", "null"]), a.forEach(function (e) {
          e.rules = e.rules.map(function (e) {
            var r, t;
            return "object" == _typeof(e) && (t = e[r = Object.keys(e)[0]], e = r, t.forEach(function (e) {
              s.push(e), a.all[e] = !0;
            })), s.push(e), a.all[e] = {
              keyword: e,
              code: o[e],
        ...
        checkDataTypes: function checkDataTypes(e, r, t) {
          {
            ...
            for (a in o.array && o.object && (s = o["null"] ? "(" : "(!" + r + " || ", s += "typeof " + r + ' !== "object")', delete o["null"], delete o.array, delete o.object), o.number && delete o.integer, o) {
              s += (s ? " && " : "") + i(a, r, t, !0);
            }
    ...
    17: [function (e, r, t) {
      ...
      r.exports = function (e, r) {
        ...
        if (d) for (var p, f = -1, m = d.length - 1; f < m;) {
          p = d[f += 1], (e.opts.strictKeywords ? "object" == _typeof(p) && 0 < Object.keys(p).length || !1 === p : e.util.schemaHasRules(p, e.RULES.all)) && (h = !1, n.schema = p, n.schemaPath = s + "[" + f + "]", n.errSchemaPath = o + "/" + f, t += "  " + e.validate(n) + " ", n.baseId = u, i && (t += " if (" + c + ") { ", l += "}"));
        }
    ...
    18: [function (e, r, t) {
      ...
      r.exports = function (r, e) {
        ...
        if (o.every(function (e) {
          return r.opts.strictKeywords ? "object" == _typeof(e) && 0 < Object.keys(e).length || !1 === e : r.util.schemaHasRules(e, r.RULES.all);
        })) {
          var m = d.baseId;
          ...
          if (y) for (var g, P = -1, E = y.length - 1; P < E;) {
            g = y[P += 1], d.schema = g, d.schemaPath = i + "[" + P + "]", d.errSchemaPath = n + "/" + P, t += "  " + r.validate(d) + " ", d.baseId = m, t += " " + u + " = " + u + " || " + f + "; if (!" + u + ") { ", p += "}";
          }
    ...
    21: [function (e, r, t) {
      ...
      r.exports = function (e, r) {
        ...
        var p,
            ...
            P = "data" + g,
            E = e.baseId,
            w = e.opts.strictKeywords ? "object" == _typeof(o) && 0 < Object.keys(o).length || !1 === o : e.util.schemaHasRules(o, e.RULES.all);
        ...
        for (I in t += "var missing" + a + ";", v) {
          if ((p = v[I]).length) {
            if (t += " if ( " + c + e.util.getProperty(I) + " !== undefined ", y && (t += " && Object.prototype.hasOwnProperty.call(" + c + ", '" + e.util.escapeQuotes(I) + "') "), l) {
              t += " && ( ";
              var P = p;
              if (P) for (var E = -1, w = P.length - 1; E < w;) {
              ...
              t += " ) { ";
              var x = p;
              if (x) for (var R, $ = -1, j = x.length - 1; $ < j;) {
                R = x[$ += 1];
    ...
    25: [function (e, r, t) {
      ...
      r.exports = function (e, r, t) {
        ...
        if (d) {
          ...
          var v,
              y,
              g = (v = "object" == _typeof(h) && !(h instanceof RegExp) && h.validate) && h.type || "string";
    ...
    26: [function (e, r, t) {
      ...
      r.exports = function (e, r) {
        ...
        var p,
            ...
            v = e.schema.then,
            y = e.schema["else"],
            g = void 0 !== v && (e.opts.strictKeywords ? "object" == _typeof(v) && 0 < Object.keys(v).length || !1 === v : e.util.schemaHasRules(v, e.RULES.all)),
            P = void 0 !== y && (e.opts.strictKeywords ? "object" == _typeof(y) && 0 < Object.keys(y).length || !1 === y : e.util.schemaHasRules(y, e.RULES.all)),
            E = d.baseId;
    ...
    31: [function (e, r, t) {
      ...
      r.exports = function (e, r) {
        ...
        if (P) for (var E, w = -1, b = P.length - 1; w < b;) {
          E = P[w += 1], (e.opts.strictKeywords ? "object" == _typeof(E) && 0 < Object.keys(E).length || !1 === E : e.util.schemaHasRules(E, e.RULES.all)) ? (d.schema = E, d.schemaPath = i + "[" + w + "]", d.errSchemaPath = n + "/" + w, t += "  " + e.validate(d) + " ", d.baseId = m) : t += " var " + f + " = true; ", w && (t += " if (" + f + " && " + v + ") { " + u + " = false; " + y + " = [" + y + ", " + w + "]; } else { ", p += "}"), t += " if (" + f + ") { " + u + " = " + v + " = true; " + y + " = " + w + "; }";
        }
    ...
    33: [function (e, r, t) {
      ...
      r.exports = function (e, r) {
        ...
        var p,
            ...
            x = b.length || _.length,
            R = !1 === F,
            $ = "object" == _typeof(F) && Object.keys(F).length,
        ...
        if (A && (!e.opts.$data || !A.$data) && A.length < e.opts.loopRequired && (p = e.util.toHash(A)), t += "var " + u + " = errors;var " + v + " = true;", O && (t += " var " + w + " = undefined;"), D) {
          if (t += O ? " " + w + " = " + w + " || Object.keys(" + c + "); for (var " + g + "=0; " + g + "<" + w + ".length; " + g + "++) { var " + y + " = " + w + "[" + g + "]; " : " for (var " + y + " in " + c + ") { ", x) {
            ...
            if (_.length) {
              var q = _;
              if (q) for (var z = -1, T = q.length - 1; z < T;) {
                te = q[z += 1], t += " || " + e.usePattern(te) + ".test(" + y + ") ";
              }
            }
        ...
        if (_.length) {
          ...
          if (re) for (var te, ae = -1, se = re.length - 1; ae < se;) {
            var oe,
                ie,
                ee = S[te = re[ae += 1]];
            (e.opts.strictKeywords ? "object" == _typeof(ee) && 0 < Object.keys(ee).length || !1 === ee : e.util.schemaHasRules(ee, e.RULES.all)) && (h.schema = ee, h.schemaPath = e.schemaPath + ".patternProperties" + e.util.getProperty(te), h.errSchemaPath = e.errSchemaPath + "/patternProperties/" + e.util.escapeFragment(te), t += O ? " " + w + " = " + w + " || Object.keys(" + c + "); for (var " + g + "=0; " + g + "<" + w + ".length; " + g + "++) { var " + y + " = " + w + "[" + g + "]; " : " for (var " + y + " in " + c + ") { ", t += " if (" + e.usePattern(te) + ".test(" + y + ")) { ", h.errorPath = e.util.getPathExpr(e.errorPath, y, e.opts.jsonPointers), oe = c + "[" + y + "]", h.dataPathArr[P] = y, ie = e.validate(h), h.baseId = I, e.util.varOccurences(ie, E) < 2 ? t += " " + e.util.varReplace(ie, E, oe) + " " : t += " var " + E + " = " + oe + "; " + ie + " ", l && (t += " if (!" + v + ") break; "), t += " } ", l && (t += " else " + v + " = true; "), t += " }  ", l && (t += " if (" + v + ") { ", d += "}"));
          }
        }
      ...
      r.exports = function (e, r) {
        ...
        if (!h) if (o.length < e.opts.loopRequired && e.schema.properties && Object.keys(e.schema.properties).length) {
          ...
          if (f) for (var m, v = -1, y = f.length - 1; v < y;) {
            ...
            g && (e.opts.strictKeywords ? "object" == _typeof(g) && 0 < Object.keys(g).length || !1 === g : e.util.schemaHasRules(g, e.RULES.all)) || (p[p.length] = m);
          }
        } else p = o;
    ...
    38: [function (e, r, t) {
      ...
      r.exports = function (a, e) {
        ...
        if (a.schema.$ref && !s) r += " " + a.RULES.all.$ref.code(a, "$ref") + " ", p && (r += " } if (errors === ", r += v ? "0" : "errs_" + l, r += ") { ", E += "}");else {
          var I = a.RULES;
          if (I) for (var A = -1, k = I.length - 1; A < k;) {
            if (Z(S = I[A += 1])) {
              if (S.type && (r += " if (" + a.util.checkDataType(S.type, f, a.opts.strictNumbers) + ") { "), a.opts.useDefaults) if ("object" == S.type && a.schema.properties) {
                var u = a.schema.properties,
                    C = Object.keys(u);
                if (C) for (var L, N = -1, q = C.length - 1; N < q;) {
                ...
                if (T) for (var Q, $ = -1, V = T.length - 1; $ < V;) {
              ...
              var U,
                  H = S.rules;
              if (H) for (var K, M, B = -1, J = H.length - 1; B < J;) {
        ...
        "function" == typeof r && (t = r, r = {}), function e(r, t, a, s, o, i, n, l, c, u) {
          if (s && "object" == _typeof(s) && !Array.isArray(s)) {
            for (var h in t(s, o, i, n, l, c, u), s) {
              ...
              if (Array.isArray(d)) {
                if (h in m.arrayKeywords) for (var p = 0; p < d.length; p++) {
                  e(r, t, a, d[p], o + "/" + h + "/" + p, i, o, h, s, p);
                }
              } else if (h in m.propsKeywords) {
                if (d && "object" == _typeof(d)) for (var f in d) {
                  e(r, t, a, d[f], o + "/" + h + "/" + f.replace(/~/g, "~0").replace(/\//g, "~1"), i, o, h, s, f);
                }
    ...
    45: [function (e, r, t) {
      ...
      a = this, function (e) {
        ...
        function r(e) {
          ...
          Z(K + "|" + B), Z(c + "\\:" + H + Z("\\?" + V) + "?"), Z(Z("\\/\\/(" + Z("(" + u + ")@") + "?(" + D + ")" + Z("\\:(" + O + ")") + "?)") + "?(" + N + "|" + q + "|" + T + "|" + Q + ")"), Z("\\?(" + V + ")"), Z("\\#(" + U + ")"), Z(Z("\\/\\/(" + Z("(" + u + ")@") + "?(" + D + ")" + Z("\\:(" + O + ")") + "?)") + "?(" + N + "|" + q + "|" + z + "|" + Q + ")"), Z("\\?(" + V + ")"), Z("\\#(" + U + ")"), Z(Z("\\/\\/(" + Z("(" + u + ")@") + "?(" + D + ")" + Z("\\:(" + O + ")") + "?)") + "?(" + N + "|" + q + "|" + T + "|" + Q + ")"), Z("\\?(" + V + ")"), Z("\\#(" + U + ")"), Z("(" + u + ")@"), Z("\\:(" + O + ")");
          return {
        ...
        function l(e) {
          ...
          for (var n = 0; n < i; ++n) {
            128 <= e.charCodeAt(n) && L("not-basic"), r.push(e.charCodeAt(n));
          }
        ...
        function g(e, r) {
          ...
          if (s) {
            for (var i = s.toLowerCase().split("::").reverse(), n = w(i, 2), l = n[0], c = n[1], u = c ? c.split(":").map(b) : [], h = l.split(":").map(b), d = r.IPV4ADDRESS.test(h[h.length - 1]), p = d ? 7 : 8, f = h.length - p, m = Array(p), v = 0; v < p; ++v) {
              m[v] = u[v] || h[f + v] || "";
            }
        ...
        function D(r) {
          ...
          var o,
              ...
              n,
              l,
              c = (i = !1 !== t.iri ? h : u, n = [], void 0 !== (o = r).userinfo && (n.push(o.userinfo), n.push("@")), void 0 !== o.host && n.push(g(S(String(o.host), i), i).replace(i.IPV6ADDRESS, function (e, r, t) {
            return "[" + r + (t ? "%25" + t : "") + "]";
        ...
        var ae = {
          ...
          serialize: function serialize(e, r) {
            ...
            for (d in h) {
              h[d] !== K[d] && p.push(d.replace(W, te).replace(W, f).replace(ee, m) + "=" + h[d].replace(W, te).replace(W, f).replace(re, m));
            }
    ...
    ajv: [function (a, e, r) {
      ...
      (e.exports = y).prototype.validate = function (e, r) {
        ...
        if (!(t = t || this._opts.defaultMeta || function (e) {
          var r = e._opts.meta;
          return e._opts.defaultMeta = "object" == _typeof(r) ? e._getId(r) || r : e.getSchema(f) ? f : void 0, e._opts.defaultMeta;

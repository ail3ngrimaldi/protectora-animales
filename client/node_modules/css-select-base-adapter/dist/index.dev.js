...
function adapterFactory(implementation) {
  ...
  var baseAdapter = {
    removeSubsets: function removeSubsets(nodes) {
      return _removeSubsets(adapter, nodes);
    },
    existsOne: function existsOne(test, elems) {
      return _existsOne(adapter, test, elems);
    },
    getSiblings: function getSiblings(elem) {
      return _getSiblings(adapter, elem);
    },
    hasAttrib: function hasAttrib(elem, name) {
      return _hasAttrib(adapter, elem, name);
    },
    findOne: function findOne(test, arr) {
      return _findOne(adapter, test, arr);
    },
    findAll: function findAll(test, elems) {
      return _findAll(adapter, test, elems);
    }
  };
...
function _removeSubsets(adapter, nodes) {
...
function _findAll(adapter, test, elems) {
  var result = [];

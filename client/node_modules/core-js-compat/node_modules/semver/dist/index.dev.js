...
var lazyRequire = function lazyRequire(path, subkey) {
  var module = lrCache[path] || (lrCache[path] = require(path));

  return subkey ? module[subkey] : module;
};

var lazyExport = function lazyExport(key, path, subkey) {
  Object.defineProperty(exports, key, {
    get: function get() {
      var res = lazyRequire(path, subkey);
      Object.defineProperty(exports, key, {
        value: res,
        enumerable: true,
        configurable: true

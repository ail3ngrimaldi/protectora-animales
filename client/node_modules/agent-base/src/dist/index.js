...
function isSecureEndpoint() {
    ...
    if (typeof stack !== 'string')
        return false;
    return stack.split('\n').some(function (l) { return l.indexOf('(https.js:') !== -1; });
}

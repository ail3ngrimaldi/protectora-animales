...
var NullThrowsReasons = {
  ...
  MissingToken: function MissingToken(token, thing) {
    return "Expected to find a ".concat(token, " for the ").concat(thing, ".");
  }
};
...
function nullThrows(value, message) {
  ...
  if (value === null || value === undefined) {
    throw new Error("Non-null Assertion Failed: ".concat(message));
  }

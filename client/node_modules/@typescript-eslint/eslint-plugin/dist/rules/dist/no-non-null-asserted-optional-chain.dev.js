...
exports["default"] = util.createRule({
  ...
  create: function create(context) {
    return {
      'TSNonNullExpression > :matches(OptionalMemberExpression, OptionalCallExpression)': function TSNonNullExpressionMatchesOptionalMemberExpressionOptionalCallExpression(node) {

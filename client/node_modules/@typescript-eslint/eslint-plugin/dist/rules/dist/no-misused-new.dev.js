...
exports["default"] = util.createRule({
  ...
  create: function create(context) {
    ...
    function isMatchingParentType(parent, returnType) {
      if (parent && 'id' in parent && parent.id && parent.id.type === experimental_utils_1.AST_NODE_TYPES.Identifier) {
    ...
    return {
      'TSInterfaceBody > TSConstructSignatureDeclaration': function TSInterfaceBodyTSConstructSignatureDeclaration(node) {
      ...
      "TSMethodSignature[key.name='constructor']": function TSMethodSignatureKeyNameConstructor(node) {
        context.report({
          node: node,
          messageId: 'errorMessageInterface'
        });
      },
      "ClassBody > MethodDefinition[key.name='new']": function ClassBodyMethodDefinitionKeyNameNew(node) {

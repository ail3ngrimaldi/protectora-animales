"use strict"; // any is required to work around manipulating the AST in weird ways
...
var no_extra_parens_1 = __importDefault(require("eslint/lib/rules/no-extra-parens"));
...
exports["default"] = util.createRule({
  ...
  create: function create(context) {
    var rules = no_extra_parens_1["default"].create(context);

    function binaryExp(node) {
      var rule = rules.BinaryExpression; // makes the rule think it should skip the left or right

      var isLeftTypeAssertion = util.isTypeAssertion(node.left);
      var isRightTypeAssertion = util.isTypeAssertion(node.right);
    ...
    function unaryUpdateExpression(node) {
      var rule = rules.UnaryExpression;

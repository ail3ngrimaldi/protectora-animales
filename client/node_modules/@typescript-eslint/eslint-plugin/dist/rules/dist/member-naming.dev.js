...
exports["default"] = util.createRule({
  ...
  create: function create(context, _ref) {
    ...
    var conventions = Object.keys(config).reduce(function (acc, accessibility) {
    ...
    function validateParameterName(node) {
      var parameterNode = getParameterNode(node);
    ...
    function validateName(node) {
      if (node.type === experimental_utils_1.AST_NODE_TYPES.MethodDefinition && node.kind === 'constructor') {
        return;
      }
    ...
    function validate(node, name) {
      var accessibility = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'public';
      var convention = conventions[accessibility];

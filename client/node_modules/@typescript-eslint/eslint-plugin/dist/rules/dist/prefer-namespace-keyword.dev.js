...
exports["default"] = util.createRule({
  ...
  create: function create(context) {
    ...
    return {
      TSModuleDeclaration: function TSModuleDeclaration(node) {
        ...
        var moduleType = sourceCode.getTokenBefore(node.id);

        if (moduleType && moduleType.type === experimental_utils_1.AST_TOKEN_TYPES.Identifier && moduleType.value === 'module') {
          context.report({
            node: node,

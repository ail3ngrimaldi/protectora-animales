...
exports["default"] = util.createRule({
  ...
  create: function create(context) {
    ...
    function isNamedFunction(node) {
      ...
      return parent.type === experimental_utils_1.AST_NODE_TYPES.MethodDefinition || parent.type === experimental_utils_1.AST_NODE_TYPES.Property && (parent.kind === 'get' || parent.kind === 'set' || parent.method);
    }
    /**

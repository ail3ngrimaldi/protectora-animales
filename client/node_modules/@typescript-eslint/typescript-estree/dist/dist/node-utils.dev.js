...
var TOKEN_TO_TEXT = (_TOKEN_TO_TEXT = {}, _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.OpenBraceToken, '{'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.CloseBraceToken, '}'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.OpenParenToken, '('), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.CloseParenToken, ')'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.OpenBracketToken, '['), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.CloseBracketToken, ']'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.DotToken, '.'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.DotDotDotToken, '...'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.SemicolonToken, ';'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.CommaToken, ','), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.LessThanToken, '<'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.GreaterThanToken, '>'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.LessThanEqualsToken, '<='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.GreaterThanEqualsToken, '>='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.EqualsEqualsToken, '=='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.ExclamationEqualsToken, '!='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.EqualsEqualsEqualsToken, '==='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.InstanceOfKeyword, 'instanceof'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.ExclamationEqualsEqualsToken, '!=='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.EqualsGreaterThanToken, '=>'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.PlusToken, '+'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.MinusToken, '-'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.AsteriskToken, '*'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.AsteriskAsteriskToken, '**'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.SlashToken, '/'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.PercentToken, '%'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.PlusPlusToken, '++'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.MinusMinusToken, '--'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.LessThanLessThanToken, '<<'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.LessThanSlashToken, '</'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.GreaterThanGreaterThanToken, '>>'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.GreaterThanGreaterThanGreaterThanToken, '>>>'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.AmpersandToken, '&'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.BarToken, '|'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.CaretToken, '^'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.ExclamationToken, '!'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.TildeToken, '~'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.AmpersandAmpersandToken, '&&'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.BarBarToken, '||'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.QuestionToken, '?'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.ColonToken, ':'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.EqualsToken, '='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.PlusEqualsToken, '+='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.MinusEqualsToken, '-='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.AsteriskEqualsToken, '*='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.AsteriskAsteriskEqualsToken, '**='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.SlashEqualsToken, '/='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.PercentEqualsToken, '%='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.LessThanLessThanEqualsToken, '<<='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.GreaterThanGreaterThanEqualsToken, '>>='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.GreaterThanGreaterThanGreaterThanEqualsToken, '>>>='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.AmpersandEqualsToken, '&='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.BarEqualsToken, '|='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.CaretEqualsToken, '^='), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.AtToken, '@'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.InKeyword, 'in'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.UniqueKeyword, 'unique'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.KeyOfKeyword, 'keyof'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.NewKeyword, 'new'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.ImportKeyword, 'import'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.ReadonlyKeyword, 'readonly'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.QuestionQuestionToken, '??'), _defineProperty(_TOKEN_TO_TEXT, SyntaxKind.QuestionDotToken, '?.'), _TOKEN_TO_TEXT);
/**

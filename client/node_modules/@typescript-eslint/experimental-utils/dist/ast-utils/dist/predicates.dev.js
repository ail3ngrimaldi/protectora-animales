...
function isOptionalOptionalCallExpression(node) {
  return node.type === ts_estree_1.AST_NODE_TYPES.OptionalCallExpression && // this flag means the call expression itself is option
...
function isTypeAssertion(node) {
  ...
  return node.type === ts_estree_1.AST_NODE_TYPES.TSAsExpression || node.type === ts_estree_1.AST_NODE_TYPES.TSTypeAssertion;
}
...
function isFunction(node) {
  ...
  return [ts_estree_1.AST_NODE_TYPES.ArrowFunctionExpression, ts_estree_1.AST_NODE_TYPES.FunctionDeclaration, ts_estree_1.AST_NODE_TYPES.FunctionExpression].includes(node.type);
}
...
function isFunctionType(node) {
  ...
  return [ts_estree_1.AST_NODE_TYPES.TSCallSignatureDeclaration, ts_estree_1.AST_NODE_TYPES.TSConstructorType, ts_estree_1.AST_NODE_TYPES.TSConstructSignatureDeclaration, ts_estree_1.AST_NODE_TYPES.TSEmptyBodyFunctionExpression, ts_estree_1.AST_NODE_TYPES.TSFunctionType, ts_estree_1.AST_NODE_TYPES.TSMethodSignature].includes(node.type);
}
...
function isClassOrTypeElement(node) {
  ...
  return [// ClassElement
  ts_estree_1.AST_NODE_TYPES.ClassProperty, ts_estree_1.AST_NODE_TYPES.FunctionExpression, ts_estree_1.AST_NODE_TYPES.MethodDefinition, ts_estree_1.AST_NODE_TYPES.TSAbstractClassProperty, ts_estree_1.AST_NODE_TYPES.TSAbstractMethodDefinition, ts_estree_1.AST_NODE_TYPES.TSEmptyBodyFunctionExpression, ts_estree_1.AST_NODE_TYPES.TSIndexSignature, // TypeElement
  ...
  ts_estree_1.AST_NODE_TYPES.TSMethodSignature, ts_estree_1.AST_NODE_TYPES.TSPropertySignature].includes(node.type);
}
...
function isConstructor(node) {
  return (node === null || node === void 0 ? void 0 : node.type) === ts_estree_1.AST_NODE_TYPES.MethodDefinition && node.kind === 'constructor';
}
...
function isMemberOrOptionalMemberExpression(node) {
  return node.type === ts_estree_1.AST_NODE_TYPES.MemberExpression || node.type === ts_estree_1.AST_NODE_TYPES.OptionalMemberExpression;
}

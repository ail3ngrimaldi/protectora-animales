...
function shouldRunInBand(tests, timings, _ref) {
  var detectOpenHandles = _ref.detectOpenHandles,
      maxWorkers = _ref.maxWorkers,
      watch = _ref.watch,
      watchAll = _ref.watchAll;
  ...
  var isWatchMode = watch || watchAll;
  var areFastTests = timings.every(function (timing) {
    return timing < SLOW_TEST_TIME;
  });
  var oneWorkerOrLess = maxWorkers <= 1;
  var oneTestOrLess = tests.length <= 1;

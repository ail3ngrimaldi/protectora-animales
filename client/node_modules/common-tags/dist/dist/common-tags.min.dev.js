...
!function (n, r) {
  ...
  var e = function () {
    ...
    return {
      onEndResult: function onEndResult(n) {
        if ("" === r) return n.trim();
  ...
  var a = function a() {
    ...
    return {
      ...
      f = function f(t, e) {
    return {
      onSubstitution: function onSubstitution(n, r) {
    ...
    return null != n && !Number.isNaN(n) && "boolean" != typeof n;
      ...
      g = function g() {
    return {
      onSubstitution: function onSubstitution(n) {
  ...
  n.TemplateTag = e, n.trimResultTransformer = u, n.stripIndentTransformer = a, n.replaceResultTransformer = s, n.replaceSubstitutionTransformer = f, n.replaceStringTransformer = function (r, t) {
    return {
      onString: function onString(n) {
        if (null == r || null == t) throw new Error("replaceStringTransformer requires at least 2 arguments.");
        return n.replace(r, t);
      }
    };
  }, n.inlineArrayTransformer = l, n.splitStringTransformer = m, n.removeNonPrintingValuesTransformer = g, n.commaLists = d, n.commaListsAnd = h, n.commaListsOr = y, n.html = w, n.codeBlock = w, n.source = w, n.safeHtml = v, n.oneLine = b, n.oneLineTrim = S, n.oneLineCommaLists = T, n.oneLineCommaListsOr = A, n.oneLineCommaListsAnd = E, n.inlineLists = L, n.oneLineInlineLists = j, n.stripIndent = R, n.stripIndents = k, Object.defineProperty(n, "__esModule", {
    value: !0
  });
});
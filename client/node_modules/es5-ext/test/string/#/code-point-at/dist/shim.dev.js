...
module.exports = function (t, a) {
  a(t.length, 1, "Length"); // String that starts with a BMP symbol
  ...
  a(t.call("abc\uD834\uDF06def", undefined), 0x61); // String that starts with an astral symbol
  ...
  a(t.call("\uD834\uDF06def", undefined), 0x1d306); // Lone high surrogates
  ...
  a(t.call("\uD834abc", undefined), 0xd834); // Lone low surrogates

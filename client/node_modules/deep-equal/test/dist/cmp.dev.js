...
test('equal', function (t) {
  t.deepEqualTest({
    ...
    a: [2, 3],
    b: [4]
  }, 'two equal objects', true, true, false);
  t.end();
});
test('not equal', function (t) {
  t.deepEqualTest({
    ...
    x: 5,
    y: 6
  }, 'two inequal objects are', false, false);
  t.end();
});
...
test('objects with strings vs numbers', function (t) {
  t.deepEqualTest([{
    ...
    b: '4'
  }], 'objects with equivalent string/number values', true, false);
  t.end();
});
...
test('buffers', function (t) {
  ...
  t.ok(equal(Buffer('xyz'), Buffer('xyz'), {
    strict: true
  }), 'strict: buffers with same contents are equal');
...
test('NaNs', function (t) {
  ...
  t.notOk(equal({
    ...
    a: NaN
  }), 'two equiv objects with a NaN value are not equiv');
  t.ok(equal({
    a: NaN
  }, {
    a: NaN
    ...
    strict: true
  }), 'strict: two equiv objects with a NaN value are equiv');
...
test('zeroes', function (t) {
  ...
  t.deepEqualTest({
    ...
    a: -0
  }, 'two objects with a same-keyed 0/-0 value', true, false);
  t.end();
});
test('Object.create', {
  skip: !Object.create
...
test('Object.create(null)', {
  ...
  t.deepEqualTest(Object.create(null, {
    a: {
      value: 'b'
    }
  }), Object.create(null, {
  ...
  }), 'two null objects with the same property pair', true, true, true);
  t.end();
});
...
test('arrays and objects', function (t) {
  ...
  t.deepEqualTest([], {
    length: 0
  }, 'empty array and empty arraylike object', false, false);
  t.deepEqualTest([1], {
    0: 1
  }, 'array and similar object', true, true);
  t.end();
});

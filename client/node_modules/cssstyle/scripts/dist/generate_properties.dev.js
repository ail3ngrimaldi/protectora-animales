...
function isRequire(node, filename) {
  if (t.isCallExpression(node) && t.isIdentifier(node.callee, {
    ...
    var fullPath = resolve.sync(relative, {
...
function getRequireValue(node, file) {
  var r, e; // replace require("./foo").bar with the named export from foo
  ...
  if (t.isMemberExpression(node, {
    ...
    return e.namedExports[node.property.name]; // replace require("./foo") with the default export of foo

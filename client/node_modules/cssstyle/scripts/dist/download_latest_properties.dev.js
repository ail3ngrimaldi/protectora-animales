...
var _require = require('../lib/parsers'),
    camelToDashed = _require.camelToDashed;
...
request(url, function (error, response, body) {
  if (!error && response.statusCode === 200) {
    var allCSSProperties = JSON.parse(body); // Filter out all properties newer than Working Draft
    ...
    workingDraftAndOlderProperties.forEach(function (cssProp) {
      var camelCaseName = toCamelCase(cssProp.property);
